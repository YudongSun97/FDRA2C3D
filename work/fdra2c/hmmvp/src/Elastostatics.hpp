#ifndef INCLUDE_HMMVP_ELASTOSTATICS
#define INCLUDE_HMMVP_ELASTOSTATICS
...
namespace hmmvp {
  ...
  namespace es {
    ...
    inline double cosd(double a) { return cos(a*M_PI/180.0); }
    ...
    namespace dc3 {
      ...
      extern "C" void dc3d_
      (const double* ALPHA, const double* X, const double* Y, const double* Z,
       const double* DEPTH, const double* DIP, const double* AL1,
