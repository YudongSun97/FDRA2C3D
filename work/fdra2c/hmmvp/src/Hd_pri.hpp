...
namespace hmmvp {
  ...
  public:
    ...
    typedef vector<Block>::const_iterator iterator;
    iterator Begin() const;
    iterator End() const;
    vector<Block>::size_type NbrBlocks() const;
  ...
  public:
    ...
    void AppendBlock(const Block& b) { blocks.push_back(b); nblocks++; }
